...
SEARCH_TERMS = [
    # --- Disney umbrella ---
    "ディズニー", "ディズニーランド", "ディズニーシー", "ディズニーリゾート", "TDR", "ディズニーストア", "disney",
    # --- Mickey & friends ---
    "ミッキー", "ミニー", "ドナルド", "デイジー", "グーフィー", "チップとデール", "チップ&デール",
    # --- Winnie the Pooh ---
    "くまのプーさん", "プーさん", "ピグレット", "ティガー", "イーヨー",
    # --- Princesses & their films ---
    "白雪姫", "シンデレラ", "オーロラ姫", "眠れる森の美女", "アリエル", "リトルマーメイド",
    "美女と野獣", "ジャスミン", "アラジン", "ラプンツェル", "塔の上のラプンツェル",
    "モアナ", "ティアナ", "ムーラン", "メリダ",
    # --- Frozen ---
    "アナと雪の女王", "エルサ", "オラフ",
    ...
    "ナイトメアビフォアクリスマス", "ナイトメア", "ジャックスケリントン",
    # --- Stitch / Lilo & Stitch ---
    "スティッチ", "リロ&スティッチ", "エンジェル", "スクランプ",
    # --- Pixar ---
    "ピクサー", "トイストーリー", "ウッディ", "バズライトイヤー",
    "リトルグリーンメン", "エイリアン", "モンスターズインク", "pixar",
